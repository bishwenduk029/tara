...
class PromptGenerator:
    ...
    def _generate_numbered_list(self, items: list, item_type: str = "list") -> str:
        ...
        if item_type == "command":
            ...
            finish_description = (
                "use this to signal outcome of the workflow execution"
            )
            finish_args = (
                '"response": "final response to let '
                'people know the outcome of the workflow execution"'
            )
            finish_string = (
...
def get_prompt(tools: List[BaseTool]) -> str:
    ...
    prompt_generator.add_constraint("Always ensure the Notion content blocks you come up with have the rich_text attribute correctly populated.")
    prompt_generator.add_constraint(
